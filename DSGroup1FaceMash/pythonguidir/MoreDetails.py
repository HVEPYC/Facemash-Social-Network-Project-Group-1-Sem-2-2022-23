...
layout = [[sg.Text("Complete your Account Registration", justification = "center", font=("Arial",15), size=(20,3), pad = ((222,25),(30,0)))],
          [sg.Text("Enter your Hobbies (Comma Seperated): ", pad=((30,0),(0,0)))],
          ...
          [sg.Button(button_text = "Let's Begin!", pad=((273,0),(30,0)), size=(15,2), key="-continue-")]]


windows = sg.Window("Complete Account Registration",layout, size=(700, 400), no_titlebar = True)
